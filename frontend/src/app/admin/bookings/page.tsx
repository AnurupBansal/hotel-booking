      ...
      <div className="flex flex-wrap gap-4">
        <label className="block">
          ...
          <input
            ...
            className="rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 outline-none focus:ring-2 focus:ring-blue-200"
          />
        </label>

        <label className="block">
          <span className="mb-1 block text-xs font-medium text-gray-600">Room</span>
          <select
            value={filterRoom}
            ...
            <tbody className="divide-y divide-gray-100">
              {bookings.map((b) => (
                <tr key={b.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 font-medium text-gray-900">₹{b.amountPaid}</td>
                  <td className="px-4 py-3">
                    <span
                  ...
                  <td className="px-4 py-3">
                    <div className="flex gap-2">
                      <Link
                        ...
                        className="rounded border border-gray-200 px-2.5 py-1 text-xs font-medium text-gray-700 transition hover:bg-gray-50"
                      >
                        Edit
                      </Link>
                      <button
